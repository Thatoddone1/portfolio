...
>
    <div class="basis-auto">
        ...
        <h1 class="p-1 pl-6 pt-3 font-bold text-5xl font-sans dark:text-white">
            Joshua
        </h1>
        <h1 class="p-1 pt-3 pl-5 font-semibold text-xl dark:text-white">
            I design apps and stuff
        </h1>
    </div>
